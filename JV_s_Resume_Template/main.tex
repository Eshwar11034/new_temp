...
%-----------EDUCATION-----------
\makeatletter
% Prints "Start -- End" only when both exist; trims spaces; 
% prints single date if only one exists; prints nothing if both empty.
\newcommand{\daterange}[2]{%
  \edef\A{\zap@space#1 \@empty}%
  \edef\B{\zap@space#2 \@empty}%
  \ifx\A\@empty
    \ifx\B\@empty
...
\newcommand{\renderExp}[1]{%
  \resumeSubheading
    ...
    {\daterange{\csname #1@Start\endcsname}{\csname #1@End\endcsname}}
...
\section{Certifications}
  \resumeSubHeadingListStart
      \resumeSubheading{SQL for Data Science}
      {2023}
      {}{}
      \vspace{-13pt}
      \resumeSubheading{Business English Communication}
      {2021}
      {}{}
  \resumeSubHeadingListEnd
