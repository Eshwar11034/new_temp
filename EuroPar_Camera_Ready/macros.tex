...
\newcommand{\slsqp} {SLSQP\xspace}
\newcommand{\qrf} {QR Factorization\xspace}
\newcommand{\qr} {QR\xspace}

%/commands for personal comments
\newcommand {\spnote}[1] {\todo[inline,size=\footnotesize,color=yellow!20]{Sathya: #1}}
\newcommand {\scnote}[1] {\todo[inline,size=\footnotesize,color=yellow!20]{Soumyajit: #1}}

\newcommand {\sccolor}[1] {\textcolor{blue}{#1}} % Soumyajit
\newcommand {\rucolor}[1] {\textcolor{orange}{#1}} % Rahul
\newcommand {\eucolor}[1] {\textcolor{yellow}{#1}} % Eshwar
\newcommand {\spcolor}[1] {\textcolor{green}{#1}} % Sathya
